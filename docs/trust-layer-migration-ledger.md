...
1. The local API and UI workers have completed artifact-backed loopback proofs.
   Repeat them on a deployed safe exact-head PR environment, then run bounded
   data verification with configured artifact storage. Add a job trigger/output
