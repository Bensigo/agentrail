...
describe("NAV_ZONES data structure", () => {
  ...
  it("Settings zone: Gateways (gateways-page T3, ABOVE Connectors), Connectors, Team, Permissions (#1278; api-keys removed 2026-07-19; Repos & Health folded into Wiki, owner ruling)", () => {
