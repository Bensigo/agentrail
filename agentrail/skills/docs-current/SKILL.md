---
name: docs-current
description: Current external documentation lookup for third-party APIs, SDK behavior, package versions, platform rules, or licensing. Use when a task depends on current API behavior, dependency versions matter, or version-sensitive framework/SDK/package behavior is involved.
---
