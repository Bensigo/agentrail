...
import { upsertReviewGate, getRepository } from "@agentrail/db-postgres";
import { requireBearer } from "../../../../../lib/bearer-auth";

const WS = "00000000-0000-0000-0000-000000000001";
const REPO = "00000000-0000-0000-0000-000000000010";
const RUN_ID = "00000000-0000-0000-0000-000000000099";
const GATE_ID = "00000000-0000-0000-0000-000000000088";
const KEY = "k1";
const TEAM = "t1";

function req(body: unknown, withAuth = true): NextRequest {
  return new NextRequest("http://localhost/api/v1/ingest/review-gates", {
    method: "POST",
    headers: {
...
const valid = {
  ...
  repository_id: REPO,
  run_id: RUN_ID,
  gate_name: "all-tests-pass",
  status: "passed",
  conditions: [{ key: "tests", value: "green" }],
  blocking_reasons: [],
  evidence_refs: [{ label: "CI run", url: "https://ci.example.com/1" }],
...
beforeEach(() => {
  ...
  vi.mocked(upsertReviewGate).mockResolvedValue(undefined);
});

describe("POST /api/v1/ingest/review-gates", () => {
  ...
  it("202 + ok:true and upsertReviewGate called with correct args on valid body", async () => {
