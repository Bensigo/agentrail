...
//
// This investigator runs as an isolated, structured task and returns one
// result; it must not stall waiting for interactive input. An evidence gap
// belongs in its degraded output, not a blocked prompt, so ask_question is
// stripped.
//
