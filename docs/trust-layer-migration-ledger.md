...
1. Run the worker against a safe exact-head environment and prove a
   criterion-specific UI flow end to end. Then run the bounded API and data
   executors with configured artifact storage; add a job trigger/output
