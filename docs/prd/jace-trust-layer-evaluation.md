...
This is the canonical post-MVP evaluation phase for the acceptance spine in
[ADR 0012](../adr/0012-jace-owns-the-acceptance-spine.md). It does not validate
the product today. Legacy AgentRail execution evaluations remain a distinct
benchmark; they are reusable infrastructure, not proof that Jace earned trust.
