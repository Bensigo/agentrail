...
//
// web_fetch reaches arbitrary external URLs. This investigator's only
// sanctioned network reach is the one configured evidence route its two
// authored tools call, so web_fetch is stripped.
//
