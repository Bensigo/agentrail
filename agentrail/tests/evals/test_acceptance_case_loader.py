...
def payload(split: str = "dev") -> dict:
    return {"name":"save-visible","split":split,"corpusVersion":"v1","userRequest":"make save visible","sourceConversation":[{"id":"m1","text":"save"}],"pinned":{"repo":"acme/app","commit":"abc"},"relevantSources":["src/save.ts:1-2"],"approvedContract":{"acceptanceCriteria":[{"id":"saved"}]},"clarificationTruth":{"necessaryQuestions":[]},"prRevisions":[{"headSha":"deadbeef","diffIdentity":"sha256:diff"}],"environments":[{"id":"preview-1","modality":"ui"}],"independentLabels":{"contract":{},"context":{},"review":{},"proof":{},"correction":{},"outcome":{}},"source":{"issue":1}}
