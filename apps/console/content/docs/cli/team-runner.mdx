...
queued issues. See [Self-hosting](/docs/getting-started/self-hosting) for the
full setup walkthrough, or [Dashboard & hosted runner](/docs/dashboard) for
what the console adds for teams.
