...
async function main() {
  ...
  const events: TelemetryEventRecord[] = [
    ...
    },
    {
      ...
      event_id: "evt-behavior-full-read",
      submission_kind: "issue",
      payload: JSON.stringify({
        type: "agent_activity",
        phase: "execute",
        turn: 1,
        summary: "Read several files before editing.",
    ...
    },
    {
      ...
      event_id: "evt-behavior-verify-skip",
      submission_kind: "issue",
      payload: JSON.stringify({
        type: "agent_activity",
        phase: "execute",
        turn: 2,
        summary: "Edited without a same-turn verification command.",
        tools: ["Edit", "Edit"],
        files_read_count: 0,
        full_file_read: 0,
        tool_loop_count: 1,
        edit_without_context: 1,
        verification_skip: 1,
      }),
      session_id: "",
      seq: 2,
