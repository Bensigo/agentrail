...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| full | 1 | 0 | 1 | 0.0% | 0.0000 | n/a | 701.3s | 0 | $0.0000 | n/a |
| new-flow | 1 | 0 | 1 | 0.0% | 0.0000 | n/a | 674.8s | 0 | $0.0000 | n/a |

## New-flow vs full

The new flow is `full` PLUS the critic (#977), best-of-N (#979), and warm-cache (#978) layers. Each delta is `new-flow` minus `full` on the SAME scorer and run set, and each can come back **worse** — solve-rate and false-green can drop, wall-time and dollars-per-solved can rise. Lower is better for dollars-per-solved, wall-time, and false-green; higher is better for solve-rate. `n/a` marks an undefined delta (an arm never solved, or its gate never passed).

| Metric | full | new-flow | Delta (new-flow - full) |
| --- | ---: | ---: | ---: |
| Solve-rate | 0.0% | 0.0% | +0.0% |
| Dollars-per-solved-task | n/a | n/a | n/a |
| Wall-time per task | 701.3s | 674.8s | -26.5s |
| False-green rate | n/a | n/a | n/a |
...
| --- | ---: | ---: | ---: | --- |
| critic | 0.0% | n/a | n/a | n/a (delta undefined — arm absent) |
| bestofn | 0.0% | n/a | n/a | n/a (delta undefined — arm absent) |
| warmcache | 0.0% | n/a | n/a | n/a (delta undefined — arm absent) |
...
| new-flow | easy | 1 | 0 | 1 | 0.0% | $0.0000 | n/a |
...
- Per arm:
  ...
  - new-flow: $0.0000 (0 solved run(s))
