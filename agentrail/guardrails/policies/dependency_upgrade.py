...
class DependencyUpgradeEvidenceGuardrail:
    ...
    description: str = (
        ...
        "evidence and Pack profiles exist for npm, Yarn Berry 4 root projects, uv, and Cargo, "
        ...
        "watcher candidate is likewise noncanonical until exact bounded evidence reaches the "
        "Acceptance Record boundary; Cargo remains excluded from legacy draft and managed "
        "execution. Go Modules remains a bounded observation-only parser foundation, excluded "
        "from evidence gates and Pack eligibility, with no managed executor. Heartbeat Go "
