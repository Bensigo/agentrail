...
// display rule (ADR 0009 / M033): a counterfactual that can never come back
// negative is marketing, not a metric. Per-agent COST (falsifiable) now lives
// in cost-meter.ts as getAgentCostBreakdown; Cost-per-Issue-to-Green and the
// cache read-to-creation ratio replace the savings surface.
// ---------------------------------------------------------------------------
