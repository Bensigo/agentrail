...
function cargoRequestBody() {
  ...
  value.runtime = { ...value.runtime, identity, version: "1.97.1" };
  value.packageManager = {
    ...value.packageManager,
    name: "cargo",
    version: "1.97.1",
  ...
  value.manifest = { ...value.manifest, path: "Cargo.toml" };
  value.lockfile = { ...value.lockfile, path: "Cargo.lock" };
  value.security = {
    ...value.security,
    identity,
