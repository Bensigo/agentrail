...
See ``agentrail/evals/README.md`` and ``docs/prd/eval-harness-isolated-layer-evals.md``.

Phase 1 ships the frozen corpus (``agentrail.evals.corpus``): the harness's irreplaceable
