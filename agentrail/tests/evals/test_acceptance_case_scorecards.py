...
def observation(**overrides):
    ...
    base = dict(case="case-1", arm="full-jace-loop", scorecard="proof", segment="ui", evidence_class="offline", independent_truth=True, jace_claim=True, provenance=provenance)
...
def test_requires_exact_complete_lineage_and_arm_appropriate_pack_identity():
    incomplete = observation().provenance.copy(); incomplete.pop("prHead")
    ...
    baseline_provenance["contextPackHash"] = "none"; baseline_provenance["contextPackTokenBudget"] = "none"
