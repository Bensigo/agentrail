...
| tokens to obtain context | 19,116,382 | 642,492 | **5,797** |
...
| --- | --- | --- |
| naive: grep, read every matched file in full | 19,116,382 | AgentRail -100% |
...
| query | required | grep R/P (n) | rg R/P (n) | AgentRail R/P (n) | AR rank |
| --- | --- | --- | --- | --- | --- |
| `jsonify` | src/flask/json/__init__.py | 1.00/0.04 (24) | 1.00/0.05 (21) | 1.00/0.14 (7) | #1 |
